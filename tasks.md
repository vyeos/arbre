...
- [ ] Confirm repo structure and App Router setup
- [ ] Add ESLint + Prettier config
- [ ] Add .env.example with required vars list
- [ ] Define local/dev/prod env strategy
- [ ] Add lint-staged + pre-commit hook
- [ ] Add testing scaffolding (unit/integration/e2e)
